...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-bd-j3&5d6#k=#@w*bpy&yu)(^x)pkrl-i!s-mgak@ez13n$w&c')
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', # <--- Agrégala de PRIMERA
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'db_conservatorio'),
        'USER': os.getenv('DB_USER', 'postgres'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'majo'),
...
# Configuración de CORS - Permitir credenciales (cookies de sesión)
